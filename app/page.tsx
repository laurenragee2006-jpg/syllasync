  ...
  return (
    <>
      <style>{`
        ...
        .ss-spinner-dark {
          border-color: rgba(61,79,46,0.2);
        ...
        {step === "input" && (
          <div>
            <div className="ss-card">
              <label className="ss-label">Paste your syllabus below</label>
              <textarea
            ...
            <button
              className="ss-btn ss-btn-forest"
              onClick={handleExtract}
              disabled={!syllabus || loading}
            >
              {loading ? (
                <><span className="ss-spinner" /> Extracting...</>
              ) : (
                <>✦ Extract deadlines</>
              )}
            </button>
        ...
        {step === "deadlines" && (
          <div>
            ...
            <div className="ss-pills">
              ...
              {uniqueTypes.map((t) => (
                <span key={t} className="ss-pill pill-type">{t}</span>
              ))}
            </div>
            ...
            <button
              className="ss-btn ss-btn-peach"
              onClick={handleSchedule}
              disabled={loading}
              style={{ marginTop: "20px" }}
            >
              {loading ? (
                <><span className="ss-spinner ss-spinner-dark" /> Building schedule...</>
              ) : (
